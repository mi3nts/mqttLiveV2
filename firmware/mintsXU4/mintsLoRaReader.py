...
def sensorSendLoRa(dateTime,nodeID,sensorID,framePort,base16Data):
    # if(sensorID=="PM"):
    #     return PMLoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data) 
    # if(sensorID=="PMSalor"):
    #     return PMSalorLoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data) 
    # if(sensorID=="INA219Duo"):
    #     return INA219DuoLoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)  
    # # if(sensorID=="MLRPS001"):
    #     return MLRPS001LoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data) 
    # if(sensorID=="PMPoLo"):
    ...
    # if(sensorID=="GPRMC"):
    #     return GPRMCLoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data) 
    if(sensorID=="GPGGAPL"):
        return GPGGAPLLoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data) 
    # if(sensorID=="GPRMCPL"):
    #     return GPRMCPLLoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data) 
    # if(sensorID=="MacAD"):
    #     return MacADLoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)
    # if(sensorID=="OPCN2"):
    #     return OPCN2LoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)
    # if(sensorID=="OPCN3"):
    #     return OPCN3LoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)    
    if(sensorID=="IPS7100"):
        return IPS7100LoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)
    if(sensorID=="IPS7100CNR"):
        return IPS7100CNRLoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)
    if(sensorID=="BME280"):
        return BME280LoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)        
    if(sensorID=="BME280V2"):
        return BME280V2LoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)    
    if(sensorID=="BME688CNR"):
        return BME688CNRLoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)            
    # if(sensorID=="SCD30"):
    #     return SCD30LoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data) 
    # if(sensorID=="MGS001"):
    #     return MGS001LoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data) 
    # if(sensorID=="MBCLR001"):
    #     return MBCLR001LoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)
    # if(sensorID=="MBCLR002"):
    #     return MBCLR002LoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)
    # if(sensorID=="AS7265X"):
    #     return AS7265XLoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)
    # if(sensorID=="AS7265X1"):
    #     return AS7265X1LoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)
    # if(sensorID=="AS7265X2"):
    #     return AS7265X2LoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)
    # if(sensorID=="RG15"):
    #     return RG15LoRaWrite(dateTime,nodeID,sensorID,framePort,base16Data)
    return;
